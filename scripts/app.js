...
const observerBusiness = new IntersectionObserver((element) => {
  elementBusinessSectionTitle.classList.toggle("animate-business-title", element.isIntersecting);
  elementBusinessSectionImages.forEach((image) => {
    image.classList.toggle("animate-business-images", element.isIntersecting);
  });
  elementBusinessSectionTexts.forEach((text) => {
    text.classList.toggle("animate-business-texts", element.isIntersecting);
  });
});
observerBusiness.observe(elementBusinessSection);

const observerWoman = new IntersectionObserver((element) => {
  elementWomanSectionCircles.classList.toggle("animate-woman-circles", element.isIntersecting);
  elementWomanSectionImage.classList.toggle("animate-woman-image", element.isIntersecting);
  elementWomanSectionBg.classList.toggle("animate-woman-bg", element.isIntersecting);
  elementWomanSectionSimpleCards.forEach((sCard) => {
    sCard.classList.toggle("animate-woman-s-cards", element.isIntersecting);
  });
  elementWomanSectionCards.forEach((card) => {
    card.classList.toggle("animate-woman-cards", element.isIntersecting);
  });
});
observerWoman.observe(elementWomanSection);

const observerDigital = new IntersectionObserver((element) => {
  elementDigitalSectionBall.classList.toggle("animate-digital-ball", element.isIntersecting);
  elementDigitalSectionWave.classList.toggle("animate-digital-wave", element.isIntersecting);
  elementDigitalSectionCube.classList.toggle("animate-digital-cube", element.isIntersecting);
  elementDigitalSectionCard.classList.toggle("animate-digital-card", element.isIntersecting);
  elementDigitalSectionWheel.classList.toggle("animate-digital-wheel", element.isIntersecting);
  elementDigitalSectionPipe.classList.toggle("animate-digital-pipe", element.isIntersecting);
});
observerDigital.observe(elementDigitalSection);

const observerWhatWeDo = new IntersectionObserver((element) => {
  elementWhatWeDoSectionBall.classList.toggle("animate-whatWeDo-ball", element.isIntersecting);
  elementWhatWeDoSectionCard.classList.toggle("animate-whatWeDo-card", element.isIntersecting);
  elementWhatWeDoSectionCube.classList.toggle("animate-whatWeDo-cube", element.isIntersecting);
  elementWhatWeDoSectionWave.classList.toggle("animate-whatWeDo-wave", element.isIntersecting);
});
observerWhatWeDo.observe(elementWhatWeDoSection);

const observerTeam = new IntersectionObserver((element) => {
  elementTeamSectionTitle.classList.toggle("animate-team-title", element.isIntersecting);
  elementTeamSectionText.classList.toggle("animate-team-info", element.isIntersecting);
});
observerTeam.observe(elementTeamSectionContainer);

const observerForm = new IntersectionObserver((element) => {
  elementFormSectionBall.classList.toggle("animate-form-ball", element.isIntersecting);
  elementFormSectionPipe.classList.toggle("animate-form-pipe", element.isIntersecting);
  elementFormSectionPipe2.classList.toggle("animate-form-pipe2", element.isIntersecting);
  elementFormSectionPottle.classList.toggle("animate-form-pottle", element.isIntersecting);
  elementFormSectionWave.classList.toggle("animate-form-wave", element.isIntersecting);
  elementFormSectionWheel.classList.toggle("animate-form-wheel", element.isIntersecting);
});
